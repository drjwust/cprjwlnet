...
//   InitECapGpio();
   ...
   ECap4Regs.ECCTL2.bit.CAP_APWM = 0;           //CAP mode
//   ECap4Regs.ECCTL2.bit.CONT_ONESHT = 0;//1;      // one shot mode
   ECap4Regs.ECCTL2.bit.SYNCI_EN = 0;         // disable sync in
   ECap4Regs.ECCTL2.bit.SYNCO_SEL = 0x3;        // Disable
   
   ECap4Regs.ECCTL1.bit.CAP1POL = 0;          // Rising edge
//   ECap4Regs.ECCTL1.bit.CAP2POL = 1;          // Falling edge
//   ECap4Regs.ECCTL1.bit.CAP3POL = 0;        //Falling edge
//   ECap4Regs.ECCTL1.bit.CAP4POL = 1;         // Rising edge
...
//   ECap4Regs.ECEINT.bit.CEVT4 = 1;/**/
   ...
   ECap5Regs.ECCTL2.bit.CAP_APWM = 0;           //CAP mode
//   ECap5Regs.ECCTL2.bit.CONT_ONESHT = 0;      // one shot mode
   ECap5Regs.ECCTL2.bit.SYNCI_EN = 0;         // disable sync in
   ECap5Regs.ECCTL2.bit.SYNCO_SEL = 3;        // Disable
   
   ECap5Regs.ECCTL1.bit.CAP1POL = 0;          // Rising edge
//   ECap5Regs.ECCTL1.bit.CAP2POL = 1;          // Rising edge
//   ECap5Regs.ECCTL1.bit.CAP3POL = 0;          // Falling edge
//   ECap5Regs.ECCTL1.bit.CAP4POL = 1;          // Rising edge
...
/*   
   ...
   ECap6Regs.ECCTL2.bit.CAP_APWM = 0;           //CAP mode
//   ECap6Regs.ECCTL2.bit.CONT_ONESHT = 0;      // one shot mode
   ECap6Regs.ECCTL2.bit.SYNCI_EN = 0x0;         // disable sync in
   ECap6Regs.ECCTL2.bit.SYNCO_SEL = 0x3;        // Disable
   
   ECap6Regs.ECCTL1.bit.CAP1POL = 0;          // Rising edge
//   ECap6Regs.ECCTL1.bit.CAP2POL = 1;          // Rising edge
//   ECap6Regs.ECCTL1.bit.CAP3POL = 0;          // Falling edge
//   ECap6Regs.ECCTL1.bit.CAP4POL = 1;          // Rising edge
...
//   ECap6Regs.ECEINT.bit.CEVT4 = 1;            // 1 events = interrupt
